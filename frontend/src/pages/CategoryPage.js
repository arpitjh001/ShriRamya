    ...
    return (
        <div className="bg-[#FAF9F6] min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="sticky top-[101px] z-30 bg-[#FAF9F6]/95 backdrop-blur-sm flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-4 pt-2 border-[#697565]/30 transition-all duration-300">
