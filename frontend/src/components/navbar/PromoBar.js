...
const PromoBar = ({ 
  ...
  return (
    <div className={`py-2 px-4 text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase overflow-hidden relative border-b z-50 transition-all duration-700 backdrop-blur-[32px] ${
      variant === 'warning'
